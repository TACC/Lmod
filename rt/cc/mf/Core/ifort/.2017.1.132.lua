...
local root = "/cvmfs/soft.computecanada.ca/easybuild/software/2017/Core/ifort/2017.1.132"
...
setenv("EBVERSIONIFORT", "2017.1.132")
setenv("EBDEVELIFORT", pathJoin(root, "easybuild/Core-ifort-.2017.1.132-easybuild-devel"))
