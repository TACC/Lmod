...
local root = "/cvmfs/soft.computecanada.ca/easybuild/software/2017/Core/intel/2014.6"

conflict("intel")

if not isloaded("icc/.2013_sp1.6.214") or mode() == "unload" then
    load("icc/.2013_sp1.6.214")
end

if not isloaded("ifort/.2013_sp1.6.214") or mode() == "unload" then
    load("ifort/.2013_sp1.6.214")
end

setenv("EBROOTICCIFORT", root)
setenv("EBVERSIONICCIFORT", "2014.6")
setenv("EBDEVELICCIFORT", pathJoin(root, "easybuild/Core-intel-2014.6-easybuild-devel"))
