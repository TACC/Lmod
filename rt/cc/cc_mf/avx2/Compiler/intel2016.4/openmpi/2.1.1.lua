...
local root = "/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/openmpi/2.1.1"

conflict("openmpi")
local mroot = os.getenv("MODULEPATH_ROOT")
prepend_path("MODULEPATH", pathJoin(mroot,"avx2/MPI/intel2016.4/openmpi2.1"))
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/avx2-Compiler-intel2016.4-openmpi-2.1.1-easybuild-devel"))
