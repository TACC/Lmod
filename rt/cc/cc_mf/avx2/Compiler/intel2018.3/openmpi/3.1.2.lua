...
local root = "/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2018.3/openmpi/3.1.2"

conflict("openmpi")
local mroot = os.getenv("MODULEPATH_ROOT")
prepend_path("MODULEPATH", pathJoin(mroot,"avx2/MPI/intel2018.3/openmpi3.1"))
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/avx2-Compiler-intel2018.3-openmpi-3.1.2-easybuild-devel"))
