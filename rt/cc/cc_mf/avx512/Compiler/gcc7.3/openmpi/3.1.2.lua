...
local root = "/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx512/Compiler/gcc7.3/openmpi/3.1.2"

conflict("openmpi")
local mroot = os.getenv("MODULEPATH_ROOT")
prepend_path("MODULEPATH", pathJoin(mroot,"avx512/MPI/gcc7.3/openmpi3.1"))
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/avx512-Compiler-gcc7.3-openmpi-3.1.2-easybuild-devel"))
