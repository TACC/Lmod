local help_message = [[
This is a module file for the container quay.io/biocontainers/esimsa:1.0--0, which exposes the
following programs:
...
set_shell_function("esimsa",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/esimsa/esimsa-1.0--0.simg esimsa $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/esimsa/esimsa-1.0--0.simg esimsa $*')
