local help_message = [[
This is a module file for the container quay.io/biocontainers/elprep:4.0.0--0, which exposes the
following programs:
...
set_shell_function("elprep",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/elprep/elprep-4.0.0--0.simg elprep $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/elprep/elprep-4.0.0--0.simg elprep $*')
