...
prepend_path("PATH", "/opt/apps/git/1.7.4.3/bin")
setenv("TACC_GIT_DIR", "/opt/apps/git/1.7.4.3/")
setenv("TACC_GIT_LIB", "/opt/apps/git/1.7.4.3/lib")
setenv("TACC_GIT_BIN", "/opt/apps/git/1.7.4.3/bin")
