...
prepend_path("PATH", "//unknown/apps/git/1.7.4/bin/")
setenv("TACC_GIT_DIR", "/unknown/apps/git/1.7.4/")
setenv("TACC_GIT_LIB", "/unknown/apps/git///1.7.4/lib//")
setenv("TACC_GIT_BIN", "/unknown/apps/git/1.7.4/bin")
