local help_msg=[[
Intel compilers 19.1.0 produce optimized code that can run significantly
...
prepend_path( "LIBRARY_PATH" ,        pathJoin( base       , "debugger_2020/libipt/intel64/lib" ) )
...
prepend_path( "LD_LIBRARY_PATH" ,        pathJoin( base       , "debugger_2020/libipt/intel64/lib" ) )
...
prepend_path( "NLSPATH" ,     pathJoin( base       , "debugger_2020/gdb/intel64/share/locale/%l_%t/%N" ) )
...
prepend_path( "MODULEPATH" , "/opt/apps/intel20/modulefiles" )
