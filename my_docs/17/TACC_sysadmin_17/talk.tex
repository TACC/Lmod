...
% * user collections
% * StdEnv
% ** How to get the Standard Env setup via /etc/profile.d/z00_lmod.sh
% ** What goes into StdEnv
% *** compiler, mpi, xalt
...
%page 24.1
\begin{frame}{A standard set of modules?}
  \begin{itemize}
    \item 
  \end{itemize}
\end{frame}
...
running: module --initial_load restore
  ...
  Setting MODULEPATH to: /opt/apps/mfiles/Darwin:/opt/apps/mfiles/Core
  Loading: unix (fn: /opt/apps/mfiles/Core/unix/unix.lua)
  Loading: local (fn: /opt/apps/mfiles/Core/local/local.lua)
  Loading: mkl (fn: /opt/apps/mfiles/Core/mkl/mkl.lua)
  Loading: gcc (fn: /opt/apps/mfiles/Darwin/gcc/5.2.lua)
  Loading: StdEnv (fn: /opt/apps/mfiles/Core/StdEnv.lua)
    \end{alltt}
}
    \item 
  \end{itemize}
