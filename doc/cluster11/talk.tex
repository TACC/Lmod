...
\begin{frame}{Enviroment Modules History (II)}
  \begin{itemize}
    ...
    \item Lmod: Lua Based Module  (2008 - now) (lmod.sf.net)
  \end{itemize}
\end{frame}
...
\begin{frame}{The Trick}
  \begin{itemize}
    \item The module command {\color{blue}\texttt{lmod}} reads module files
  ...
  \begin{itemize}
    \item Generic:
      \begin{itemize}
        ...
        \item Modulefile: \texttt{\$M/Core}\emph{package/version}
      \end{itemize}
    \item Git 1.8
      \begin{itemize}
        \item Package: \texttt{/opt/apps/git/1.8}
        \item Modulefile: \texttt{\$M/Core/git/1.8}
      \end{itemize}
    \item Intel compilers 11.1
      \begin{itemize}
        \item Package: \texttt{/opt/apps/Core/intel/11.1}
        \item Modulefile: \texttt{\$M/Core/intel/11.1}
        \item Modulefile adds \texttt{\$M/Compiler/intel/11.1} to \texttt{MODULEPATH}
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Key Insight (II): \texttt{MODULEPATH}}
  \begin{itemize}
    ...
    \item M=/opt/apps/modulefiles
      \begin{itemize}
        \item Adds \texttt{\$M/Compiler/gcc/4.5} to
          \texttt{MODULEPATH}.
        \item Boost: \texttt{\$M/Compiler/gcc/4.5/boost/1.47.1}
      \end{itemize}
    \item Unloading gcc/4.5
      \begin{itemize}
        \item Removes \texttt{\$M/Compiler/gcc/4.5}
          from \texttt{MODULEPATH}.
        \item Inactivates boost/1.47.1
      \end{itemize}
    \item Loading intel/11.1
      \begin{itemize}
        \item Adds \texttt{\$M/Compiler/intel/11.1} to
          \texttt{MODULEPATH}.
        \item Activates Boost: \texttt{\$M/Compiler/intel/11.1/boost/1.47.1}
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Management of Modules}
  \begin{itemize}
    ...
    \item Use {\color{brown}\texttt{prereq("foo","bar")}} instead of
      {\color{brown}\texttt{load("foo","bar")}}
    \item Use  {\color{brown}\texttt{family("compiler")}} and similar
