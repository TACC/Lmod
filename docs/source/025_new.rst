...
**New module function protected_getenv{} provided**
  (Lmod 9.2.6+) A new function **protected_getenv{}** is provided to a
  protected value mainly for *module show*.  This way modules that
  depend on other module to define an environment variable can provide
  a default value instead in certain provide module modes.
