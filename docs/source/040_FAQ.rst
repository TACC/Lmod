...
scripts such as job submission scripts?
   ...
   correctly in bash interactive subshells.  If they don't then your
...
How to use module commands inside a Makefile:
   ...
   Tmod define MODULESHOME to point to the top of the module source and
   both tools use the same initialization strategy.
